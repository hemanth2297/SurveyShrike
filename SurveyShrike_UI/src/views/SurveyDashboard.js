  ...
  componentDidMount = () => {
    ...
    getAllSurvyes().then(response => {
      ...
      for (let i = 0; i < response.results.length; i++) {
        ...
        response["results"][i]["date"] = "21 October 2019"
    ...
    return (
      <Container fluid className="main-content-container px-4">
        ...
        <Row noGutters className="page-header py-4">
          <PageTitle sm="4" title="Surveys" subtitle="All" className="text-sm-left" />
        </Row>
              ...
              <Card small className="card-post card-post--1">
                ...
                <CardBody>
                  <h5 className="card-title" style={{ minHeight: "20px" }}>
                    <a href={"/survey-form?surveyName=" + post.surveyName} target="_blank" rel="noopener noreferrer" className="text-fiord-blue">
                      {post.surveyName}
                    </a>
                  </h5>
